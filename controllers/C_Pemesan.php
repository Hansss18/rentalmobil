...
class C_Pemesan extends Controller{
	...
	public function tambah(){
		...
		$kasal = $_FILES['ktp']['tmp_name'];
		$kekstensi = pathinfo($_FILES['ktp']['name'], PATHINFO_EXTENSION);
		$kerror = $_FILES['ktp']['error'];
	...
	public function hapus($id = null){
		...
		$gambar = $this->pemesan->detail($id)->fetch_object()->ktp;
