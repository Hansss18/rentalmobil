...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 25, 2022 at 07:57 PM
...
INSERT INTO `tbl_akun` (`id`, `nama`, `username`, `password`, `foto`, `level`) VALUES
(10, 'Luky Fahmi', 'Luky', '$2y$10$.7aT9ZLIxypwSRTw5Pa06.dSkaUwCwwx7wne4Qoln4dEoY0EQaS0a', 'luky-fahmi-1608009844.JPG', 'admin'),
(11, 'Putri Shofi', 'Putri', '$2y$10$c3Yb2lPKI4s4TnSQV6gyuO8F/O6TVC5/M2HcRWFqVhA/8ApiyxDzK', 'putri-shofi-1608010106.png', 'admin'),
(13, 'Farhan Ab.G', 'hans', '$2y$10$D9INqBoPrz1mS/LUNY85Kua16JTnDRtbWlFvlre.JtQt4w1w0GafO', 'farhan-ab.g-1654742120.jpg', 'admin');
...
(23, 'Agiya', 'Silver', 'D 3221', 4, 2020, 'agiya-1654745969.png', 8);
...
INSERT INTO `tbl_pemesan` (`id`, `nama`, `alamat`, `jenis_kelamin`, `foto`, `ktp`) VALUES
(13, 'Udin', 'Jl Raya Kronjo', 'L', 'udin-1655351067.png', '	\r\nluky-fahmi-1608009407.JPG'),
(14, 'Nita', 'Jl. Raya', 'P', 'nita-1655485110.jpg', 'nita-1655485110.jpg');
...
(10, 'Tangerang', 'Bandung', 80),
(11, 'Bandung', 'Subang', 30);
...
INSERT INTO `tbl_pesanan` (`id`, `harga`, `tgl_pinjam`, `tgl_kembali`, `id_pemesan`, `id_mobil`, `id_perjalanan`, `id_jenis_bayar`, `bukti`) VALUES
...
(9, 600000, '2020-12-15', '2020-12-20', NULL, 14, 5, 5, ''),
(10, 10000000, '2020-12-15', '2020-12-25', NULL, 18, 5, 3, ''),
(11, 20000000, '2020-12-15', '2020-12-31', NULL, 16, 6, 3, ''),
(13, 100000, '2022-06-16', '2022-06-18', NULL, 16, 10, 8, ''),
(14, 500000, '2022-06-18', '2022-06-19', 13, 14, 3, 3, 'toyota-kijang-innova-1579004786.png');
