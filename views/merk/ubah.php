							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('merk/proses_ubah/' . $merk->id) ?>">
								  	<div class="form-group">
										...
										<input type="text" class="form-control" name="merk" id="merk" autocomplete="off" required="required" placeholder="Nama" value="<?= $merk->merk ?>">
								  	</div>
								  	<div class="form-group">
										<button type="submit" class="btn btn-sm btn-success" name="ubah"><i class="fa fa-pen"></i> Ubah</button>
										<a href="<?= base_url('merk') ?>" class="btn btn-sm btn-danger"><i class="fa fa-times"></i> Batal</a>
								  	</div>
								</form>
							</div>
						</div>
