							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('pemesan/tambah') ?>" enctype="multipart/form-data">
									...
									<div class="form-group">
								  	...
								  	<div class="form-group">
								  		<label for="ktp">Foto KTP Pelanggan</label>
								  		<input type="file" name="ktp" id="ktp" required="required" placeholder="Foto Pelanggan" autocomplete="off" class="form-control-file">
								  	</div>								  	
								  	<div class="form-group">
