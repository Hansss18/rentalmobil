							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('pemesan/proses_ubah/' . $pemesan->id) ?>" enctype="multipart/form-data">
								  	<div class="form-group">
								  		...
								  		<input type="text" value="<?= $pemesan->nama ?>" name="nama" id="nama" required="required" placeholder="Nama" autocomplete="off" class="form-control">
								  	</div>
								  	<div class="form-group">
									...
									<div class="form-group">
								  		...
								  		<textarea name="alamat" id="alamat" rows="3" class="form-control" placeholder="Alamat"><?= $pemesan->alamat ?></textarea>
								  	</div>

								  	<div class="form-group">
								  		<label for="foto">Foto Pelanggan</label>
								  		<input type="file" name="foto" id="foto"  required="required" placeholder="Foto Pelanggan" autocomplete="off" class="form-control-file">
								  	</div>
								  	<div class="form-group">
								  		<label for="foto">Foto KTP</label>
								  		<input type="file" name="ktp" id="ktp" required="required" placeholder="Foto ktp" autocomplete="off" class="form-control-file">
								  	</div>								  	
								  	<div class="form-group">
										<button type="submit" class="btn btn-sm btn-success" name="ubah"><i class="fa fa-pen"></i> Ubah</button>
										<a href="<?= base_url('pemesan') ?>" class="btn btn-sm btn-danger"><i class="fa fa-times"></i> Batal</a>
								  	</div>
								</form>
							</div>
						</div>
