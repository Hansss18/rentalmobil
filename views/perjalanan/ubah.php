							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('perjalanan/proses_ubah/' . $perjalanan->id) ?>">
								  	<div class="form-group">
										...
										<input type="text" value="<?= $perjalanan->asal ?>" class="form-control" name="asal" id="asal" autocomplete="off" required="required" placeholder="Kota Asal">
								  	</div>
								  	<div class="form-group">
										<label for="tujuan">Kota Tujuan</label>
										<input type="text" value="<?= $perjalanan->tujuan ?>" class="form-control" name="tujuan" id="tujuan" autocomplete="off" required="required" placeholder="Kota Tujuan">
								  	</div>
								  	<div class="form-group">
										<label for="jarak">Jarak (dalam KM)</label>
										<input type="number" value="<?= $perjalanan->jarak ?>" class="form-control" name="jarak" id="jarak" autocomplete="off" required="required" placeholder="Jarak">
								  	</div>
								  	<div class="form-group">
										<button type="submit" class="btn btn-sm btn-success" name="ubah"><i class="fa fa-pen"></i> Ubah</button>
										<a href="<?= base_url('perjalanan') ?>" class="btn btn-sm btn-danger"><i class="fa fa-times"></i> Batal</a>
								  	</div>
								</form>
							</div>
						</div>
